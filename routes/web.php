...
use App\Http\Controllers\SuperAdmin\PengembalianBarangController;
...
Route::prefix('/')->group(function () {
    ...
    Route::prefix('/inventaris-barang')->group(function () {
        ...
        Route::get('/', [UserInventarisBarangController::class, 'index'])->name('inventaris_barang.index');
        Route::get('/detail/{id_item_barang}', [UserInventarisBarangController::class, 'detail'])->name('inventaris_barang.detail');
        Route::get('/filter-barang', [UserInventarisBarangController::class, 'filterInventarisBarang'])->name('inventaris_barang.filterInventarisBarang');
    });

    Route::prefix('/tanah')->group(function () {
        Route::get('/', [UserInventarisTanahController::class, 'index'])->name('user.inventaris_tanah.index');
        Route::get('/filter-tanah', [UserInventarisTanahController::class, 'filterInventarisTanah'])->name('user.inventaris_tanah.filterInventarisTanah');
        Route::get('/detail/{id_tanah}', [UserInventarisTanahController::class, 'detail'])->name('user.inventaris_tanah.detail');
    });

    Route::prefix('/bangunan')->group(function () {
        Route::get('/', [UserInventarisBangunanController::class, 'index'])->name('user.inventaris_bangunan.index');
        Route::get('/filter-bangunan', [UserInventarisBangunanController::class, 'filterInventarisBangunan'])->name('user.inventaris_bangunan.filterInventarisBangunan');
        Route::get('/detail/{id_item_bangunan}', [UserInventarisBangunanController::class, 'detail'])->name('user.inventaris_bangunan.detail');
    });

    Route::get('/informasi-barang/{id_item_barang}', [UserInventarisBarangController::class, 'info'])->name('barang.info');
    Route::get('/informasi-ruangan/{id_ruangan}', [UserInventarisBarangController::class, 'ruangan'])->name('ruangan.info');
});
