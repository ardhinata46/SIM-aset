...
class InventarisBarangController extends Controller
{
    ...
    {
        $title = 'Perawatan Inventaris Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Penghapusan Aset Barang | Sistem Manajemen Aset';
    ...
    {
        $title = "Detail Item Barang | Inventaris Sistem Manajemen Aset";
