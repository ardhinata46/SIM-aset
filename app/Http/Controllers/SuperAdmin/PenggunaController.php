...
class PenggunaController extends Controller
{
    ...
    {
        $title = 'Data Pengguna | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Pengguna | Sistem Manajemen Aset';
    ...
    {
        $title = 'Detail Pengguna | Sistem Manajemen Aset';
    ...
    {
        $title = 'Ubah Pengguna | Sistem Manajemen Aset';
        $pengguna = Pengguna::select(
            'penggunas.id_pengguna',
            'penggunas.nama_pengguna',
            'penggunas.role',
