...
class PengadaanTanahController extends Controller
{
    public function index()
    {
        ...
        $title = 'Data Pengadaan Aset Tanah | Sistem Manajemen Aset';
    ...
    public function add()
    {
        ...
        $title = 'Tambah Pengadaan Aset Tanah | Sistem Manajemen Aset';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                ...
                $pengadaanTanah->foto = 'foto/' . $fotoName;
            }
            ...
            $tanah->foto = $pengadaanTanah->foto;
    ...
    public function edit($id_pengadaan_tanah)
    {
        ...
        $title = 'Ubah Pengadaan Tanah | Sistem Manajemen Aset AA';
    ...
    public function detail($id_pengadaan_tanah)
    {
        ...
        $title = 'Detail Pengadaan Aset Tanah | Sistem Manajemen Aset';
