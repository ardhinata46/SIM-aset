...
class PengadaanBarangController extends Controller
{
    ...
    {
        $title = "Pengadaan Aset Barang | Sistem Manajemen Aset";
    ...
    {
        $kategoriBarang = KategoriBarang::get();
        $title = 'Pengadaan Barang Inventaris | Sistem Manajemen Aset';
        $barang = Barang::all();
...
//            dd($e->getMessage());
    ...
    {
        $title = 'Detail Pengadaan Barang Inventaris | Sistem Manajemen Aset';
    ...
    {
        $title = "Ubah Pengadan Barang | Sistem Manajemen Aset";
        $pengadaanBarang = PengadaanBarang::findOrFail($id_pengadaan_barang);
