...
class PengadaanBangunanController extends Controller
{
    ...
    {
        $title = 'Pengadaan Bangunan Baru | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Pengadaan Bangunan Baru | Sistem Manajemen Aset';
        $tanah = Tanah::all();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                ...
                $pengadaanBangunan->foto = 'foto/' . $fotoName;
            }
            ...
            $bangunan->foto = $pengadaanBangunan->foto;
    ...
    {
        $title = "Ubah Pengadaan Bangunan | Sistem Manajemen Aset";
    ...
    public function update(Request $request, $id_pengadaan_bangunan)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                ...
                // Gunakan nota lama jika tidak ada nota baru yang diunggah
                $pengadaanBangunan->foto = $pengadaanBangunan->foto;
            }
    ...
    {
        $title = 'Detail Pengadaan Bangunan | Sistem Manajemen Aset';
