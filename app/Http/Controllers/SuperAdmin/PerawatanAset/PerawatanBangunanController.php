...
class PerawatanBangunanController extends Controller
{
    ...
    {
        $title = 'Data Perawatan Aset Bangunan | Sistem Manajemen Aset';
    ...
    public function add()
    {
        ...
        $title = 'Tambah Perawatan Bangunan | Sistem Manajemen Aset';
    ...
    {
        $title = 'Perawatan Aset Bangunan | Sistem Manajemen Aset';
        $perawatanBangunan = PerawatanBangunan::findOrFail($id_perawatan_bangunan);
        $bangunan = Bangunan::where('status', 1)->get();
