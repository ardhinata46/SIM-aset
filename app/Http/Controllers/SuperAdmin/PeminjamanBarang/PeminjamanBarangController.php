...
class PeminjamanBarangController extends Controller
{
    ...
    public function add()
    {
        $title = 'Tambah Peminjaman Barang | Inventaris GPIBI AA';
    ...
    {
        $title = 'Detail Peminjaman Barang | Inventaris GPIBI AA';
    ...
    {
        $title = "Ubah Peminjaman Barang | Inventaris GPIBI AA";
    ...
    {
        $title = 'Pengembalian Barang | Inventaris GPIBI AA';
    ...
    {
        $title = 'Barang Belum Dikembalikan | Inventaris GPIBI AA';
