...
class PengembalianBarangController extends Controller
{
    ...
    {
        $title = 'Pengembalian Barang Pinjaman | Sistem Manajemen Aset';
...
//        $peminjaman = PeminjamanBarang::select('peminjaman_barangs.*','pengembalian_barangs.*','item_peminjaman_barangs.*','item_barangs.*')
//            ->join('pengembalian_barangs', 'pengembalian_barangs.id_pengembalian_barang','=', 'peminjaman_barangs.id_peminjaman_barang')
//            ->join('item_peminjaman_barangs', 'item_peminjaman_barangs.id_item_peminjaman_barang', '=','peminjaman_barangs.id_item_peminjaman_barang')
//            ->join('item_barangs', 'item_barangs.id_item_barang','=', 'peminjaman_barangs.id_item_barang')
//            ->where('peminjaman_barangs.status', 0)->get();
//        dd($peminjaman);
        $title = 'Tambah Pengambalian Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Ubah Pengembalian Barang | Sistem Manajemen Aset';
