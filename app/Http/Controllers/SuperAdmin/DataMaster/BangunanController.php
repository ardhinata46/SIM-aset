...
class BangunanController extends Controller
{
    ...
    {
        $title = 'Data Bangunan | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Data Bangunan | Sistem Manajemen Aset';
        $tanah = Tanah::all();
...
//                dd($fotoPath);
    ...
    {
        $title = 'Detail Data Bangunan | Sistem Manajemen Aset';
    ...
    {
        $title = 'Ubah Data Bangunan | Sistem Manajemen Aset';
