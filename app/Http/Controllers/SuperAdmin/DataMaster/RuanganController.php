...
class RuanganController extends Controller
{
    ...
    {
        $title = 'Ruangan | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Ruangan | Sistem Manajemen Aset';
    ...
    {
        $title = 'Ubah Ruangan | Sistem Manajemen Aset';
    ...
    {
        $title = 'Mutasi Barang | Sistem Manajemen Aset';
