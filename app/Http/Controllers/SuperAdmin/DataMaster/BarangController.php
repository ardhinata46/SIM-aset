...
class BarangController extends Controller
{
    ...
    {
        $title = 'Data Barang | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Data Barang | Sistem Manajemen Aset';
        $kategoriBarang = KategoriBarang::get();
    ...
    {
        $title = 'Ubah Data Barang | Sistem Manajemen Aset';
        $kategoriBarang = KategoriBarang::get();
    ...
    {
        $title = 'Detail Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Tambah Item Barang | Sistem Manajemen Aset';
        $barang = Barang::findOrfail($id_barang);
...
//            dd($barangFoto);
    ...
    {
        $title = 'Ubah Item Barang | Sistem Manajemen Aset';
        $barang = Barang::get();
        $itemBarang = ItemBarang::select('item_barangs.*', 'barangs.nama_barang as nama_barang', 'barangs.kode_barang as kode_barang')
            ->join('barangs', 'barangs.id_barang', '=', 'item_barangs.id_barang')
            ->where('item_barangs.id_item_barang', $id_item_barang)
    ...
    public function updateItem(Request $request, $id_item_barang)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            $fotoName = time() . '.' . $foto->getClientOriginalExtension();
            $foto->move($fotoPath, $fotoName);
            $itemBarang->foto = 'foto/' . $fotoName;
        } else {
            // Gunakan nota lama jika tidak ada nota baru yang diunggah
            $itemBarang->foto = $itemBarang->foto;
        }
