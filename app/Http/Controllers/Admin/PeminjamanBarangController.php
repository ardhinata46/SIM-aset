...
class PeminjamanBarangController extends Controller
{
    ...
    {
        $title = 'Peminjaman Barang | Sistem Manajemen Aset';
    ...
    public function add()
    {
        $title = 'Tambah Peminjaman Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Detail Peminjaman Barang | Sistem Manajemen Aset';
    ...
    {
        $title = "Ubah Peminjaman Barang | Sistem Manajemen Aset";
    ...
    {
        $title = 'Pengembalian Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Barang Belum Dikembalikan | Sistem Manajemen Aset';
