...
class PerawatanBarangController extends Controller
{
    ...
    {
        $title = 'Data Perawatan Aset Barang | Sistem Manajemen Aset';
    ...
    public function add()
    {
        ...
        $title = 'Tambah Perawatan Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Detail Perawatan Aset Barang | Sistem Manajemen Aset';
    ...
    {
        $title = 'Ubah Perawatan Barang | Sistem Manajemen Aset';
        $barang = ItemBarang::where('status', 1)->get();
