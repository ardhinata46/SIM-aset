                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                <td>
                                    <a href="{{ route('user.inventaris_bangunan.detail', $row->id_bangunan) }}" data-toggle="tooltip" data-placement="top" title="Detail Item Bangunan" class="btn btn-outline-primary btn-sm">
...
<div class="modal fade" id="inventarisBangunanModal" tabindex="-1" role="dialog" aria-labelledby="inventarisBangunanModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.inventaris_bangunan.filterInventarisBangunan') }}">
                @csrf
