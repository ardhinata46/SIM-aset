                    ...
                    <table class="table align-items-center table-flush" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('user.inventaris_tanah.detail', $row->id_tanah) }}" data-toggle="tooltip" data-placement="top" title="Detail Tanah" class="btn btn-outline-primary btn-sm">
...
<div class="modal fade" id="inventarisTanahModal" tabindex="-1" role="dialog" aria-labelledby="inventarisTanahModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('user.inventaris_tanah.filterInventarisTanah') }}">
                @csrf
