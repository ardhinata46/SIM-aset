    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-sm table-borderless table-detail">
                ...
                <tr>
                    <th style="align-items: center">Nota</th>
                    <td>:
                        @if ($detail->nota)
                ...
                <tr>
                    <th style="align-items: center">Foto</th>
                    <td>:
                        @if ($detail->foto)
                            <a href="{{ asset($detail->foto) }}" target="_blank" title="Lihat Nota">
                                <img src="{{ asset($detail->foto) }}" alt="Nota" class="nota-image">
                            </a>
                        @endif
                    </td>
                </tr>
