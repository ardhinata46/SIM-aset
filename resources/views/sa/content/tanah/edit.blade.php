            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" class="form-control" id="foto" accept="image/*" value="{{ $tanah->foto }}"  onchange="tampilkanPreview(this, 'tampilkanFoto')">
                        <p></p>
                        <img id="tampilkanFoto" src="{{asset($tanah->foto)}}" alt="" width="100%"/>
                        @error('foto')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
