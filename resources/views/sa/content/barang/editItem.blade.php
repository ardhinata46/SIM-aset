...
<form method="POST" action="{{ route('superadmin.barang.update_item_barang', $itemBarang->id_item_barang) }}" enctype="multipart/form-data">
    @csrf
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" class="form-control" id="foto" accept="image/*" value="{{ $itemBarang->foto }}"  onchange="tampilkanPreview(this, 'tampilkanFoto')">
                        <p></p>
                        <img id="tampilkanFoto" src="{{asset($itemBarang->foto)}}" alt="" width="100%"/>
                        @error('foto')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
